...
object nivel {
		...
		const troncos = [
			new Tronco(posY = 7 ,velocidad = 1000, image = "assets/TRONCO.png"),
			new Tronco(posY = 8, velocidad = 500, image = "assets/TRONCO.png"),
			new Tronco(posY = 9, velocidad = 800, image = "assets/TRONCO.png"),
			new Tronco(posY = 10, velocidad = 1000, image = "assets/TRONCO.png"),
			new Tronco(posY = 11, velocidad = 500, image = "assets/TRONCO.png")
		]
